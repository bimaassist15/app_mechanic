        ...
        <div class="row mb-3 handle-berkala d-none">
            ...
            <div class="col-lg-6">
                ...
                <x-form-textarea-vertical label="Pesan Whatsapp Servis Berkala" name="pesanwa_pservis"
                    placeholder="Pesan Whatsapp Servis Berkala..." value="{{ $row->pesanwa_pservis ?? 'Kendaraan Anda Sudah Waktunya Melakukan Servis Berkala sesuai dengan tanggal yang sudah ditentukan dari kami. ' }}" />
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-lg-12">
