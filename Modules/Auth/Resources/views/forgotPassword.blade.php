            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Masukan email kamu, dan kamu akan mendapatkan notifikasi ke gmail anda</p>
                        ...
                        <div class="text-center">
                            <a href="{{ url('auth') }}" class="d-flex align-items-center justify-content-center">
