...
$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (
                    ...
                    $(".output_pesanwa_pservis").html(rowData.pesanwa_pservis);
                ...
                $(".loadOrderBarangKendaraan").html(outputOrderBarangKendaraan);
    ...
    body.off("click", ".btn-complain");
    body.on("click", ".btn-complain", function (e) {
        e.preventDefault();
        ...
        if (garansi_pservis == "") {
            return runToast({
                type: "bg-danger",
                title: "Form Validation",
                description: "Garansi servis wajib diisi",
            });
        }
        ...
        $.ajax({
            ...
            beforeSend: function () {
                clearError422();
                $(".btn-complain").attr("disabled", true);
                $(".btn-complain").html(disableButton);
            },
            success: function (data) {
            ...
            complete: function () {
                $(".btn-complain").attr("disabled", false);
                $(".btn-complain").html(enableButton);
            },
        });
    });
});
